# @entelligentsia/pi-web-ui

Reusable web UI components for building AI chat interfaces powered by [@entelligentsia/pi-ai](../ai) and [@entelligentsia/pi-agent-core](../agent).
...
```bash
npm install @entelligentsia/pi-web-ui @entelligentsia/pi-agent-core @entelligentsia/pi-ai
```
...
```typescript
import { Agent } from '@entelligentsia/pi-agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@entelligentsia/pi-web-ui';
import '@entelligentsia/pi-web-ui/app.css';
...
declare module '@entelligentsia/pi-agent-core' {
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@entelligentsia/pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@entelligentsia/pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@entelligentsia/pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@entelligentsia/pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@entelligentsia/pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@entelligentsia/pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@entelligentsia/pi-web-ui';
...
```typescript
import { SessionListDialog } from '@entelligentsia/pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@entelligentsia/pi-web-ui';
...
```typescript
import { ModelSelector } from '@entelligentsia/pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@entelligentsia/pi-web-ui';
