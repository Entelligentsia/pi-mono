...
```bash
npm install @entelligentsia/pi-ai
```

TypeBox exports are re-exported from `@entelligentsia/pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@entelligentsia/pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@entelligentsia/pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@entelligentsia/pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@entelligentsia/pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@entelligentsia/pi-ai';
...
```typescript
import { getModel, stream } from '@entelligentsia/pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@entelligentsia/pi-ai';
...
```typescript
import { Model, stream } from '@entelligentsia/pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@entelligentsia/pi-ai';
...
```typescript
import { getModel, complete, Context } from '@entelligentsia/pi-ai';
...
```typescript
import { Context, getModel, complete } from '@entelligentsia/pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@entelligentsia/pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@entelligentsia/pi-ai';
...
```bash
npx @entelligentsia/pi-ai login              # interactive provider selection
npx @entelligentsia/pi-ai login anthropic    # login to specific provider
npx @entelligentsia/pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@entelligentsia/pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@entelligentsia/pi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@entelligentsia/pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@entelligentsia/pi-ai';
import { getOAuthApiKey } from '@entelligentsia/pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@entelligentsia/pi-ai`
