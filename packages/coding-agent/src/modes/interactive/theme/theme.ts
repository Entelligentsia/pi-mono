...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@entelligentsia/pi-tui";
...
const THEME_KEY = Symbol.for("@entelligentsia/pi-coding-agent:theme");
// Bridge for environments that still reference upstream's scope (e.g. mixed dev installs).
const THEME_KEY_OLD = Symbol.for("@earendil-works/pi-coding-agent:theme");
...
export function getSettingsListTheme(): import("@entelligentsia/pi-tui").SettingsListTheme {
	return {
