...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@entelligentsia/pi-coding-agent";
...
```bash
npm install @entelligentsia/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@entelligentsia/pi-coding-agent";
...
The `Agent` class (from `@entelligentsia/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@entelligentsia/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@entelligentsia/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@entelligentsia/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@entelligentsia/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@entelligentsia/pi-coding-agent";
