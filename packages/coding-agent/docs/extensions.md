...
| Package | Purpose |
|---------|---------|
| `@entelligentsia/pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@entelligentsia/pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@entelligentsia/pi-tui` | TUI components for custom rendering |
...
```typescript
import { isBashToolResult } from "@entelligentsia/pi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@entelligentsia/pi-coding-agent";
...
```typescript
import { SessionManager } from "@entelligentsia/pi-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@entelligentsia/pi-tui";
...
```typescript
import { withFileMutationQueue } from "@entelligentsia/pi-coding-agent";
...
import { Type } from "typebox";
import { StringEnum } from "@entelligentsia/pi-ai";
import { Text } from "@entelligentsia/pi-tui";
...
**Important:** Use `StringEnum` from `@entelligentsia/pi-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@entelligentsia/pi-coding-agent";
...
```typescript
import { createBashTool } from "@entelligentsia/pi-coding-agent";
...
```typescript
import { keyHint } from "@entelligentsia/pi-coding-agent";
...
```typescript
import { Text, Component } from "@entelligentsia/pi-tui";
...
import { matchesKey } from "@entelligentsia/pi-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@entelligentsia/pi-coding-agent";
