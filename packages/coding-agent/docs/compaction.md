...
For TypeScript definitions in your project, inspect `node_modules/@entelligentsia/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@entelligentsia/pi-coding-agent";
