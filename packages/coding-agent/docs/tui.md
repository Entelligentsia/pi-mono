...
**Source:** [`@entelligentsia/pi-tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@entelligentsia/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@entelligentsia/pi-tui";
...
Import from `@entelligentsia/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@entelligentsia/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@entelligentsia/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@entelligentsia/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@entelligentsia/pi-coding-agent";
import { Markdown } from "@entelligentsia/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@entelligentsia/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@entelligentsia/pi-coding-agent";
import { DynamicBorder } from "@entelligentsia/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@entelligentsia/pi-tui";
...
```typescript
import { BorderedLoader } from "@entelligentsia/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@entelligentsia/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@entelligentsia/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@entelligentsia/pi-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@entelligentsia/pi-coding-agent";
import { matchesKey, truncateToWidth } from "@entelligentsia/pi-tui";
