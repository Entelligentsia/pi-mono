...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@entelligentsia/pi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@entelligentsia/pi-tui";
